...
export function calculateMuslimInheritance(
  ...
  return {
    ...
    disclaimer:
      'এই ফরায়েজ ফলাফল গণপ্রজাতন্ত্রী বাংলাদেশ সরকারের উত্তরাধিকার ক্যালকুলেটর (uttoradhikar.gov.bd), হানাফি ফিকহ ও মুসলিম পারিবারিক আইন ১৯৬১ অনুসরণে প্রস্তুতকৃত। জমি রেজিস্ট্রি বা নামজারি করার পূর্বে মূল খতিয়ান যাচাই আবশ্যক।',
  };
}
